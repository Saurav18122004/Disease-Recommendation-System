...
df = pd.read_csv("Training.csv")  # Replace with your actual training data file
...
symptom_input = st.multiselect("Select symptoms:", options=list(symptoms_dict.keys()))

if st.button("Predict"):
    if not symptom_input:
        st.warning("⚠️ Please select at least one symptom.")
    else:
        valid_symptoms = [s for s in symptom_input if s in symptoms_dict]
        disease = get_predicted_value(valid_symptoms)
